            ...
            <div class="page-section section mt-80 mt-lg-60 mt-md-60 mt-sm-60 mt-xs-40 mb-80 mb-lg-60 mb-md-60 mb-sm-60 mb-xs-40">
                ...
                <div class="row">
                    ...
                    <%
                        ...
                        ArrayList<Product> arr = (ArrayList<Product>) request.getAttribute("listSearch");
                        String search = null;
                        if (request.getAttribute("search") != null) {
                    ...
                    <div class="col-12">
                        <ul class="page-pagination">
                            ...
                            <%
                                for (int i = 1; i <= a; i++) {
                                    int sort = 0;
                                    if (request.getAttribute("sortby") != null && request.getAttribute("sortby") != "") {
                                        sort = Integer.parseInt(request.getAttribute("sortby").toString());
                                    }
                                    if (search != null) {
                            %>
                            <li class=""><a href="./search?searchString=<%=search%>&page=<%=i%>&sortby=<%=sort == 0 ? "" : sort%>"><%=i%></a></li>
                                <%

                                } else {
                                %>
                            <li class=""><a href="./search?page=<%=i%>&sortby=<%=sort == 0 ? "" : sort%>"><%=i%></a></li><%
                                    }
                                }
                                %>
